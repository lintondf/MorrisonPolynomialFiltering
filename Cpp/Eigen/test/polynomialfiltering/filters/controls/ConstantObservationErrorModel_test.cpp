...
TEST_CASE("ConstantObservationErrorModel_test") {
    SUBCASE("test1Scalar") {
        PolynomialFiltering::filters::controls::ConstantObservationErrorModel_test::TestConstantObservationErrorModel::test1Scalar();
    }
    SUBCASE("test2Matrix") {
        PolynomialFiltering::filters::controls::ConstantObservationErrorModel_test::TestConstantObservationErrorModel::test2Matrix();
    }
    SUBCASE("test3MatrixMatrix") {
        PolynomialFiltering::filters::controls::ConstantObservationErrorModel_test::TestConstantObservationErrorModel::test3MatrixMatrix();
    }
}
